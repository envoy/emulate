...
A Next.js app with emulators embedded directly via `@envoy/emulators-adapter-next`. No separate emulator process needed.
...
|---|---|---|
| Emulator process | Separate `npx @envoy/emulate` process | Embedded in the Next.js app |
...
| Extra dependency | None | `@envoy/emulators-adapter-next` |
