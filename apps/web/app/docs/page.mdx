...
npx @envoy/emulate init --service github
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>none</td>
      <td>Override the advertised base URL (supports <code>{'{service}'}</code> template)</td>
    </tr>
    <tr>
      <td><code>--portless</code></td>
      <td>off</td>
      <td>Serve over HTTPS through portless and register service aliases</td>
    </tr>
    <tr>
